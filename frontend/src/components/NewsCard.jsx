...
export default function NewsCard({ article, searchTerm }) {
  ...
  return (
    <>
      <div className="bg-white dark:bg-gray-700 rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col">
        {article.imageUrl && (
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-4 line-clamp-3">
          <HighlightText text={article.summary} searchTerm={searchTerm} />
        </p>
          ...
          <div className="flex flex-col gap-2">
            <button
              ...
              className="inline-flex items-center justify-center px-4 py-2 bg-purple-600 dark:bg-purple-700 text-white rounded-md font-semibold hover:bg-purple-700 dark:hover:bg-purple-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm"
            >
              {loadingFullSummary ? (
                <>
            ...
            <a
              ...
              className="inline-flex items-center justify-center text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-semibold text-sm"
            >
              Read full article
